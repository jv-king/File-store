...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://{encoded_username}:{encoded_password}@reapers.hvxag.mongodb.net/?retryWrites=true&w=majority&appName=Reapers")
