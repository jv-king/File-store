...
APP_ID = int(os.environ.get("APP_ID", "SoulReapersx_bot"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "1868dea7a187d9060a3c57be6a0f4182")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002097394516"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5248001163"))
